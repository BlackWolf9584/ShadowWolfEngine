...
namespace Wolf {
	...
	{
		SW_CORE_ASSERT(renderPass, "Render pass cannot be null!");
	...
	{
		SW_CORE_ASSERT(s_Data.m_ActiveRenderPass, "No active render pass! Have you called Renderer::EndRenderPass twice?");
