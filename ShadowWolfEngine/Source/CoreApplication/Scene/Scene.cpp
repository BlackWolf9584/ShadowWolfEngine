...
namespace SW
{
	...
	void OnScriptComponentConstruct(entt::registry& registry, entt::entity entity)
	{
		...
		SW_CORE_ASSERT(scene->m_EntityIDMap.find(entityID) != scene->m_EntityIDMap.end());
	...
	void Scene::OnRenderRuntime(TimeStep ts)
	{
		...
		SW_CORE_ASSERT(cameraEntity, "Scene does not contain any cameras!");
	...
	Entity Scene::CreateEntityWithID(UUID uuid, const std::string& name, bool runtimeMap)
	{
		...
		SW_CORE_ASSERT(m_EntityIDMap.find(uuid) == m_EntityIDMap.end());
